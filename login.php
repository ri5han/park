            ...
            <center>
                <div style="color:white;" class="login-bg-content">
                    <div class="login">
                        ...
                        <br><br>
                        <input name="login" class="login-btn" style="width: 30%; background-color: #ff4b20;border-color: #ff4b20;font-weight: 900;" type="submit" value="LOGIN">
                        </form>
                        <br><br><br>
                        <h4>Don't have an account ?</h4><br><a style="background-color: #3385ff;text-decoration: none; color:white;padding: 10px; border-radius: 25px;" href="signup.html">SIGN UP</a>
                    </div>
                </div>
            </center>
        </div>
