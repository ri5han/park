...
<body>
    <div class="about-bg">
        ...
        <nav class="topnav" id="myTopnav">
            ...
            <a style="margin: 3% 0 0 0%; text-align:center; color: #ff4b20;" href="about.php">ABOUT</a>
        ...
        <div class="home-bg-overlay">
            <div class="home-bg-content slidein">
                <h1><span style="color: #ff4b20;">A</span><span>bout</span> &nbsp;<span
                        style="color: #ff4b20;">U</span><span>s</span></h1>
                <!--                <h2>Because life is too precious to waste time to find parking.</h2>-->
                <h2>Who are we, what we do and how we work at <span style="color: #ff4b20;">Park</span><span>inzo</span>
                </h2>
            </div>
        </div>
    </div>
    ...
    <div style="text-align:center;" class="who-we-are">
        <div class="home-bg-overlay">
            ...
            <div class="dash"></div>
            <br><br>
            <h2 style="color: #e54600;">We are a bunch of hardworking humans creating something simple yet <br>effective
                at a larger scale.</h2>
            <br><br>
            <h3 style="text-align: center;">Hence we built Parkinzo, a simple smart parking facility that has the
                potential<br>to change the way we drive the world.</h3><br><br>
    ...
    <div class="row">
        ...
        background-color: #fff7f4;" class="what-we-do">
            ...
            <h3>For Users:-</h3>
            <p>We provide users with real-time parking locations and its stats making users easy to find parking slots
                in a blink of an eye. You get to reserve a parking slot before hand or on the spot and just go to the
                loaction and park.</p>
            <br><br>
            <h3>For Organizations:- </h3>
            <p>We are not a parking management company. While we do manage a part of your parking management, our core
                intention is to develop ways in order to revolutionize parking management. We are trying our best
                through our softare, apps, machine learning and IoT systems to make parking systems efficient and more
                secure while also minimizing human intervention in technology. <br><br>This does not mean we are
                diminishing jobs. While automation is been seen the way of the future, automation is nothing without
                human touch. Hence, we are constantly working on making your lives more convinient through technology
                while also retaining the human force needed to catch the bar.</p>
        </div>
    ...
    <div style="background-color: #fff7f4;">
        ...
        <div class="row how-this-works">
            ...
            <div class="column">
                ...
                <p>Pay from your existing wallet balance or via card, Netbanking, digital wallets, etc within few
                    seconds. You recieve an OTP after paying</p>
            </div>
            ...
            <div class="column">
                ...
                <p>Finally park your ride. Get real time occupancy info and on-street parking for short time booking.
                </p>
            </div>
